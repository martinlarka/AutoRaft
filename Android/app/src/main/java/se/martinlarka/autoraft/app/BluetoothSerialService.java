...
public class BluetoothSerialService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(AutoRaft.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(AutoRaft.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(AutoRaft.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(AutoRaft.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(AutoRaft.TOAST, mContext.getString(R.string.toast_unable_to_connect) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(AutoRaft.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(AutoRaft.TOAST, mContext.getString(R.string.toast_connection_lost) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    //mHandler.obtainMessage(AutoRaft.MESSAGE_READ, bytes, -1, buffer).sendToTarget();
                } catch (IOException e) {
